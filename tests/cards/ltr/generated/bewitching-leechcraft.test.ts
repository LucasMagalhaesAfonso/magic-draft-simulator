...
describe("Bewitching Leechcraft", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["bewitching leechcraft"]).toBeDefined();
  });

  it('[etb] has tap effect in DB', () => {
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "bewitching leechcraft", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
