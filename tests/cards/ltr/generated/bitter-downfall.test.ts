...
describe("Bitter Downfall", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["bitter downfall"]).toBeDefined();
  });
  ...
  it('[cast] self loses 2 life', () => {
    const game = new TestGame();
    game.setLife(0, 20);
    game.resolveEffect(0, {"type":"loseLife","amount":2,"target":"target_controller"});
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "bitter downfall", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
