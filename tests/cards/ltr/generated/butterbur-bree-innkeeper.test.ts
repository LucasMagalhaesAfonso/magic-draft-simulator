...
describe("Butterbur, Bree Innkeeper", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["butterbur, bree innkeeper"]).toBeDefined();
  });
  ...
  it('[trigger:end_step] creates 1 Food token(s)', () => {
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "butterbur, bree innkeeper", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
