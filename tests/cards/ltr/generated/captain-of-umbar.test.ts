...
describe("Captain Of Umbar", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["captain of umbar"]).toBeDefined();
  });

  it('[activated[0]] has loot effect in DB', () => {
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "captain of umbar", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
