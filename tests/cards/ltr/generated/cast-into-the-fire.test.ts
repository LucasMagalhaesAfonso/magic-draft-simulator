...
describe("Cast Into The Fire", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["cast into the fire"]).toBeDefined();
  });

  it('[cast] modal has 2 mode(s)', () => {
  ...
  it('[cast] modal sets _pendingModal for human player', () => {
    ...
    game.resolveEffect(0, {"type":"modal","modes":[[{"type":"damage","amount":1,"target":"creature","up_to":2}],[{"type":"exile","target":"artifact"}]]}, {});
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "cast into the fire", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
