...
describe("Celeborn The Wise", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["celeborn the wise"]).toBeDefined();
  });
  ...
  it('[trigger:attacks] scry 1 — sets _pendingScry for human', () => {
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "celeborn the wise", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
