...
describe("Cirith Ungol Patrol", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["cirith ungol patrol"]).toBeDefined();
  });
  ...
  it('[activated[0]] creates 1 Food token(s)', () => {
    const game = new TestGame();
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "cirith ungol patrol", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
