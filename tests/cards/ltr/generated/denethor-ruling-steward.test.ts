...
describe("Denethor, Ruling Steward", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["denethor, ruling steward"]).toBeDefined();
  });
  ...
  it('[trigger:end_step] creates 1 Human Soldier token(s)', () => {
  ...
  it('[activated[0]] has drain effect in DB', () => {
    const db = CardEffectsDB['denethor, ruling steward'];
    const json = JSON.stringify(db);
    expect(json).toContain("drain");
  });
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "denethor, ruling steward", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
