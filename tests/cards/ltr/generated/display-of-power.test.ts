...
describe("Display Of Power", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["display of power"]).toBeDefined();
  });

  it('[cast] has copy_spell effect in DB', () => {
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "display of power", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
