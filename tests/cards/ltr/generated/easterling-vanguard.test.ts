...
describe("Easterling Vanguard", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["easterling vanguard"]).toBeDefined();
  });
  ...
  it('[trigger:dies] amasses 1 (creates/grows Orc Army)', () => {
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "easterling vanguard", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
