...
describe("Eastfarthing Farmer", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["eastfarthing farmer"]).toBeDefined();
  });

  it('[etb] creates 1 Food token(s)', () => {
    const game = new TestGame();
    game.resolveEffect(0, {"type":"create_token","power":0,"toughness":0,"name":"Food","type_line":"Token Artifact — Food"});
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "eastfarthing farmer", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
