...
describe("Elrond, Lord Of Rivendell", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["elrond, lord of rivendell"]).toBeDefined();
  });
  ...
  it('[trigger:enters_battlefield] scry 1 — sets _pendingScry for human', () => {
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "elrond, lord of rivendell", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
