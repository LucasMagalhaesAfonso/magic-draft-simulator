...
describe("Enraged Huorn", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["enraged huorn"]).toBeDefined();
  });

  it('has keyword: trample', () => {
    const game = new TestGame();
    const card = game.addToBattlefield(0, { name: "enraged huorn", type_line: 'Creature', power: '1', toughness: '1', keywords: ["trample"] });
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "enraged huorn", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
