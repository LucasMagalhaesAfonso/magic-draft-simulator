...
describe("Esquire Of The King", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["esquire of the king"]).toBeDefined();
  });

  it('[activated[0]] has buff_all effect in DB', () => {
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "esquire of the king", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
