...
describe("Fire Of Orthanc", () => {
  ...
  it('[cast] destroys target artifact_or_land', () => {
    const game = new TestGame();
    const target = game.addToBattlefield(1, { name: 'Target', type_line: 'Artifact' });
    game.resolveEffect(0, {"type":"destroy","target":"artifact_or_land"}, { targetUid: target._uid });
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "fire of orthanc", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
