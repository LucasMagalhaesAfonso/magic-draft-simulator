...
describe("Galadhrim Bow", () => {
  ...
  it('has keyword: flash', () => {
    ...
    const card = game.addToBattlefield(0, { name: "galadhrim bow", type_line: 'Creature', power: '1', toughness: '1', keywords: ["flash"] });
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "galadhrim bow", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
