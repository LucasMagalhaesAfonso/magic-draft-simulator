...
describe("Gandalf, Friend Of The Shire", () => {
  ...
  it('has keyword: flash', () => {
    ...
    const card = game.addToBattlefield(0, { name: "gandalf, friend of the shire", type_line: 'Creature', power: '1', toughness: '1', keywords: ["flash"] });
    expect(CardUtils.hasKeyword(card, "flash")).toBe(true);
  });

  it('has "ring_tempts" trigger in DB', () => {
    const db = CardEffectsDB['gandalf, friend of the shire'];
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "gandalf, friend of the shire", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
