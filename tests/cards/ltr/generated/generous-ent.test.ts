...
describe("Generous Ent", () => {
  ...
  it('has keyword: reach', () => {
    ...
    const card = game.addToBattlefield(0, { name: "generous ent", type_line: 'Creature', power: '1', toughness: '1', keywords: ["reach"] });
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "generous ent", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
