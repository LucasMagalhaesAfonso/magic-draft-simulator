...
describe("Gift Of Strands", () => {
  ...
  it('has keyword: flash', () => {
    ...
    const card = game.addToBattlefield(0, { name: "gift of strands", type_line: 'Creature', power: '1', toughness: '1', keywords: ["flash"] });
    expect(CardUtils.hasKeyword(card, "flash")).toBe(true);
  });

  it('[etb] scry 2 — sets _pendingScry for human', () => {
    const game = new TestGame();
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "gift of strands", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
