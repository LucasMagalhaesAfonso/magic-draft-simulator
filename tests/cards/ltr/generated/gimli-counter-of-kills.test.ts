...
describe("Gimli, Counter Of Kills", () => {
  ...
  it('has keyword: trample', () => {
    ...
    const card = game.addToBattlefield(0, { name: "gimli, counter of kills", type_line: 'Creature', power: '1', toughness: '1', keywords: ["trample"] });
    expect(CardUtils.hasKeyword(card, "trample")).toBe(true);
  });

  it('has "opponent_creature_dies" trigger in DB', () => {
    const db = CardEffectsDB['gimli, counter of kills'];
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "gimli, counter of kills", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
