...
describe("Goblin Fireleaper", () => {
  ...
  it('has "dies" trigger in DB', () => {
    const db = CardEffectsDB['goblin fireleaper'];
    const trigger = db.triggered?.find((t: any) => t.event === "dies");
    expect(trigger).toBeDefined();
  });

  it('[activated[0]] buffs self +1/+0 (end_of_turn)', () => {
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "goblin fireleaper", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
