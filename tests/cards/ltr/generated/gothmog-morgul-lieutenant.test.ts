...
describe("Gothmog, Morgul Lieutenant", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["gothmog, morgul lieutenant"]).toBeDefined();
  });
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "gothmog, morgul lieutenant", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
