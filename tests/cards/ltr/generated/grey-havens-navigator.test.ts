...
describe("Grey Havens Navigator", () => {
  ...
  it('has keyword: flash', () => {
    ...
    const card = game.addToBattlefield(0, { name: "grey havens navigator", type_line: 'Creature', power: '1', toughness: '1', keywords: ["flash"] });
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "grey havens navigator", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
