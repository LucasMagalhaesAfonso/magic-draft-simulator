...
describe("Grond, The Gatebreaker", () => {
  ...
  it('has keyword: trample', () => {
    ...
    const card = game.addToBattlefield(0, { name: "grond, the gatebreaker", type_line: 'Creature', power: '1', toughness: '1', keywords: ["trample"] });
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "grond, the gatebreaker", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
