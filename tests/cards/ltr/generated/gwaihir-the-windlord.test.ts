...
describe("Gwaihir The Windlord", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["gwaihir the windlord"]).toBeDefined();
  });

  it('has keyword: flying', () => {
    const game = new TestGame();
    const card = game.addToBattlefield(0, { name: "gwaihir the windlord", type_line: 'Creature', power: '1', toughness: '1', keywords: ["flying","vigilance"] });
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "gwaihir the windlord", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
