...
describe("Hew The Entwood", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["hew the entwood"]).toBeDefined();
  });
  ...
  it('[cast] ramp — puts land onto battlefield', () => {
    ...
    game.resolveEffect(0, {"type":"ramp","amount":"sacrificed_count"});
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "hew the entwood", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
