...
describe("Hithlain Knots", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["hithlain knots"]).toBeDefined();
  });

  it('[cast] has tap effect in DB', () => {
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "hithlain knots", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
