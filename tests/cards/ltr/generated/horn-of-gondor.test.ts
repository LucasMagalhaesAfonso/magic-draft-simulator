...
describe("Horn Of Gondor", () => {
  ...
  it('[etb] creates 1 Human Soldier token(s)', () => {
  ...
  it('[activated[0]] creates Human Soldier token (dynamic count: human_count)', () => {
    // Dynamic count requires game context — verify DB has create_token effect
    const db = CardEffectsDB['horn of gondor'];
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "horn of gondor", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
