...
describe("Lost Isle Calling", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["lost isle calling"]).toBeDefined();
  });
  ...
  it('[trigger:scry] has counter_self effect in DB', () => {
    const db = CardEffectsDB['lost isle calling'];
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "lost isle calling", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
