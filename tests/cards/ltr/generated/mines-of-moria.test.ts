...
describe("Mines Of Moria", () => {
  ...
  it('[activated[0]] creates 2 Treasure token(s)', () => {
    const game = new TestGame();
    game.resolveEffect(0, {"type":"create_token","power":0,"toughness":0,"name":"Treasure","count":2});
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "mines of moria", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
