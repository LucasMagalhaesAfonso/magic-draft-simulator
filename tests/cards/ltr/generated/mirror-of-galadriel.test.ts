...
describe("Mirror Of Galadriel", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["mirror of galadriel"]).toBeDefined();
  });

  it('[activated[0]] scry 1 — sets _pendingScry for human', () => {
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "mirror of galadriel", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
