...
describe("Mithril Coat", () => {
  ...
  it('has keyword: flash', () => {
    ...
    const card = game.addToBattlefield(0, { name: "mithril coat", type_line: 'Creature', power: '1', toughness: '1', keywords: ["flash","indestructible"] });
  ...
  it('[etb] has attach effect in DB', () => {
    const db = CardEffectsDB['mithril coat'];
    const json = JSON.stringify(db);
    expect(json).toContain("attach");
  });
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "mithril coat", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
