...
describe("Nasty End", () => {
  ...
  it('[cast] draws 2 card(s)', () => {
    ...
    expect(game.hand(0).length).toBe(before + 2);
  });

  it('has sacrifice additional cost (alternate_cost: none)', () => {
    const db = CardEffectsDB["nasty end"];
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "nasty end", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
