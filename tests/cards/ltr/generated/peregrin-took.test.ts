...
describe("Peregrin Took", () => {
  ...
  it('[etb] creates 1 Food token(s)', () => {
    ...
    game.resolveEffect(0, {"type":"create_token","name":"Food","type_line":"Artifact — Food"});
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "peregrin took", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
