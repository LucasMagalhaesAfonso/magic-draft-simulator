...
describe("Press The Enemy", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["press the enemy"]).toBeDefined();
  });
  ...
  it('[cast] bounces creature to hand', () => {
    ...
    game.resolveEffect(0, {"type":"bounce","target":"nonland_permanent"}, { targetUid: target._uid });
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "press the enemy", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
