...
describe("Prince Imrahil The Fair", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["prince imrahil the fair"]).toBeDefined();
  });
  ...
  it('[trigger:second_draw] creates 1 Human Soldier token(s)', () => {
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "prince imrahil the fair", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
