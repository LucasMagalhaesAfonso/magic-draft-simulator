...
describe("Revive The Shire", () => {
  ...
  it('[cast] has return_from_graveyard effect in DB', () => {
    const db = CardEffectsDB['revive the shire'];
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "revive the shire", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
