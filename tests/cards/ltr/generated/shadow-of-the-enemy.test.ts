...
describe("Shadow Of The Enemy", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["shadow of the enemy"]).toBeDefined();
  });

  it('[cast] has exile_graveyard effect in DB', () => {
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "shadow of the enemy", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
