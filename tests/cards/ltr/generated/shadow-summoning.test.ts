...
describe("Shadow Summoning", () => {
  ...
  it('[cast] creates 2 Spirit token(s)', () => {
    const game = new TestGame();
    game.resolveEffect(0, {"type":"create_token","power":1,"toughness":1,"name":"Spirit","type_line":"Creature — Spirit","colors":["W"],"keywords":["flying"],"count":2,"tapped":true});
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "shadow summoning", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
