...
describe("Shadowfax, Lord Of Horses", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["shadowfax, lord of horses"]).toBeDefined();
  });

  it('has keyword: haste', () => {
    const game = new TestGame();
    const card = game.addToBattlefield(0, { name: "shadowfax, lord of horses", type_line: 'Creature', power: '1', toughness: '1', keywords: ["haste"] });
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "shadowfax, lord of horses", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
