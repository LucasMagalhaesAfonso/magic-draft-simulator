...
describe("Shagrat, Loot Bearer", () => {
  ...
  it('[trigger:attacks] has attach_equipment_to_self effect in DB', () => {
    const db = CardEffectsDB['shagrat, loot bearer'];
    const json = JSON.stringify(db);
    expect(json).toContain("attach_equipment_to_self");
  });
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "shagrat, loot bearer", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
