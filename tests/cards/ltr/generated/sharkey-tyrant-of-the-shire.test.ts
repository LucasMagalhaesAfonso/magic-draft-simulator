...
describe("Sharkey, Tyrant Of The Shire", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["sharkey, tyrant of the shire"]).toBeDefined();
  });

  it('has keyword: menace', () => {
    const game = new TestGame();
    const card = game.addToBattlefield(0, { name: "sharkey, tyrant of the shire", type_line: 'Creature', power: '1', toughness: '1', keywords: ["menace"] });
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "sharkey, tyrant of the shire", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
