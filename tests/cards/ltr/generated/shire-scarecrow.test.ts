...
describe("Shire Scarecrow", () => {
  ...
  it('has keyword: defender', () => {
    ...
    const card = game.addToBattlefield(0, { name: "shire scarecrow", type_line: 'Creature', power: '1', toughness: '1', keywords: ["defender"] });
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "shire scarecrow", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
