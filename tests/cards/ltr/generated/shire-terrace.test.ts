...
describe("Shire Terrace", () => {
  ...
  it('[activated[0]] ramp — puts land onto battlefield', () => {
    ...
    game.resolveEffect(0, {"type":"ramp","amount":1,"tapped":true});
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "shire terrace", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
