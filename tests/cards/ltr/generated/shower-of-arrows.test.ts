...
describe("Shower Of Arrows", () => {
  ...
  it('[cast] destroys target artifact_or_enchantment_or_flyer', () => {
    const game = new TestGame();
    const target = game.addToBattlefield(1, { name: 'Target', type_line: 'Enchantment' });
    game.resolveEffect(0, {"type":"destroy","target":"artifact_or_enchantment_or_flyer"}, { targetUid: target._uid });
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "shower of arrows", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
