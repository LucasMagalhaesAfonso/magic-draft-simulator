...
describe("Slip On The Ring", () => {
  ...
  it('[cast] exiles a permanent', () => {
    // exile effect is defined in DB
    const db = CardEffectsDB['slip on the ring'];
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "slip on the ring", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
