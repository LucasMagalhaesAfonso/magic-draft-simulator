...
describe("Stew The Coneys", () => {
  ...
  it('[cast] has fight effect in DB', () => {
    const db = CardEffectsDB['stew the coneys'];
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "stew the coneys", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
