...
describe("Swarming Of Moria", () => {
  ...
  it('[cast] creates 1 Treasure token(s)', () => {
  ...
  it('[cast] amasses 2 (creates/grows Orc Army)', () => {
    const game = new TestGame();
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "swarming of moria", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
