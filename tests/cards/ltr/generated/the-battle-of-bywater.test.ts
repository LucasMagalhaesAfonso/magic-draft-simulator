...
describe("The Battle Of Bywater", () => {
  ...
  it('[cast] creates 1 Food token(s)', () => {
    ...
    game.resolveEffect(0, {"type":"create_token","name":"Food","amount":"creatures_you_control"});
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "the battle of bywater", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
