...
describe("The One Ring", () => {
  ...
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB["the one ring"]).toBeDefined();
  });

  it('has keyword: indestructible', () => {
    const game = new TestGame();
    const card = game.addToBattlefield(0, { name: "the one ring", type_line: 'Creature', power: '1', toughness: '1', keywords: ["indestructible"] });
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "the one ring", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
