...
describe("The Torment Of Gollum", () => {
  ...
  it('[cast] has discard effect in DB', () => {
    const db = CardEffectsDB['the torment of gollum'];
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "the torment of gollum", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
