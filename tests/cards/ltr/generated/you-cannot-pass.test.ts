...
describe("You Cannot Pass!", () => {
  ...
  it('[cast] has destroy effect (conditional target: creature_blocked_or_blocked_legendary)', () => {
    const db = CardEffectsDB['you cannot pass!'];
  ...
  describe('Cast flow', () => {
    it('AI can cast without crash', () => {
      ...
      const card = game.addToHand(0, { name: "you cannot pass!", type_line: 'Instant', mana_cost: '{1}', cmc: 1 });
