...
describe('Mauhúr, Uruk-hai Captain', () => {
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB['mauhúr, uruk-hai captain']).toBeDefined();
  });

  it('has Menace', () => {
    const game = new TestGame();
    const card = game.addToBattlefield(0, { name: 'Mauhúr, Uruk-hai Captain', type_line: 'Legendary Creature — Orc Soldier', power: '2', toughness: '2', keywords: ["Menace"] });
  ...
  it('involves +1/+1 counters', () => {
    ...
    const dbEntry = CardEffectsDB['mauhúr, uruk-hai captain'];
