...
describe('Avenger of the Fallen', () => {
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB['avenger of the fallen']).toBeDefined();
  });

  it('has Deathtouch', () => {
    const game = new TestGame();
    const card = game.addToBattlefield(0, { name: 'Avenger of the Fallen', type_line: 'Creature — Human Warrior', power: '2', toughness: '4', keywords: ["Mobilize","Deathtouch"] });
  ...
  it('has attacks trigger', () => {
    ...
    const dbEntry = CardEffectsDB['avenger of the fallen'];
