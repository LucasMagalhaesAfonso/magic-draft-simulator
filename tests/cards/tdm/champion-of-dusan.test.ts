...
describe('Champion of Dusan', () => {
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB['champion of dusan']).toBeDefined();
  });

  it('has Trample', () => {
    const game = new TestGame();
    const card = game.addToBattlefield(0, { name: 'Champion of Dusan', type_line: 'Creature — Human Warrior', power: '4', toughness: '2', keywords: ["Renew","Trample"] });
  ...
  it('involves +1/+1 counters', () => {
    ...
    const dbEntry = CardEffectsDB['champion of dusan'];
