...
describe('Kishla Skimmer', () => {
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB['kishla skimmer']).toBeDefined();
  });

  it('has Flying', () => {
    const game = new TestGame();
    const card = game.addToBattlefield(0, { name: 'Kishla Skimmer', type_line: 'Creature — Bird Scout', power: '2', toughness: '2', keywords: ["Flying"] });
