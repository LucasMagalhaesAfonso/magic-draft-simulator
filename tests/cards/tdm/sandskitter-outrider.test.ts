...
describe('Sandskitter Outrider', () => {
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB['sandskitter outrider']).toBeDefined();
  });

  it('has Menace', () => {
    const game = new TestGame();
    const card = game.addToBattlefield(0, { name: 'Sandskitter Outrider', type_line: 'Creature — Goblin Soldier', power: '2', toughness: '1', keywords: ["Menace","Endure"] });
  ...
  it('involves +1/+1 counters', () => {
    ...
    const dbEntry = CardEffectsDB['sandskitter outrider'];
