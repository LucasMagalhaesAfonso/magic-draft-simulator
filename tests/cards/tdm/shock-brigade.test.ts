...
describe('Shock Brigade', () => {
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB['shock brigade']).toBeDefined();
  });

  it('has Menace', () => {
    const game = new TestGame();
    const card = game.addToBattlefield(0, { name: 'Shock Brigade', type_line: 'Creature — Goblin Soldier', power: '1', toughness: '3', keywords: ["Menace","Mobilize"] });
  ...
  it('has attacks trigger', () => {
    ...
    const dbEntry = CardEffectsDB['shock brigade'];
