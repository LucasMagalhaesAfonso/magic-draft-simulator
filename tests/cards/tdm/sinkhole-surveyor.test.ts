...
describe('Sinkhole Surveyor', () => {
  it('exists in CardEffectsDB', () => {
    expect(CardEffectsDB['sinkhole surveyor']).toBeDefined();
  });

  it('has Flying', () => {
    const game = new TestGame();
    const card = game.addToBattlefield(0, { name: 'Sinkhole Surveyor', type_line: 'Creature — Bird Scout', power: '1', toughness: '3', keywords: ["Endure","Flying"] });
  ...
  it('has attacks trigger', () => {
    ...
    const dbEntry = CardEffectsDB['sinkhole surveyor'];
